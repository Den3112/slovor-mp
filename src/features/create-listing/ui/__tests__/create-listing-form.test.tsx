...
vi.mock('@/features/create-listing/ui/form-steps/step-category', () => ({
...
vi.mock('@/features/create-listing/ui/form-steps/step-details', () => ({
  StepDetails: () => <div data-testid="step-details">Step Details Form</div>,
}))
vi.mock('@/features/create-listing/ui/form-steps/step-images', () => ({
  StepImages: () => <div data-testid="step-images">Step Images Form</div>,
}))

vi.mock('@/features/create-listing/ui/listing-preview', () => ({
  ListingPreview: () => (
