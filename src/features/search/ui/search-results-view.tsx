...
import { Pagination } from '@/entities/category'
import { useTranslation } from '@/shared/lib/i18n'
import type { Listing } from '@/shared/lib/api'
import { SortSelect } from './sort-select'
import { ZeroResultsDiscovery } from './zero-results-discovery'
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Note: In the original page.tsx, the header was outside the results block.
          ...
          Let's create `components/search/SearchHeader.tsx` as an un-planned but necessary extra step to fulfill the "Global Dynamic Localization" goal.
