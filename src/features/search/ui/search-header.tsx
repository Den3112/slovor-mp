...
export function SearchHeader({ query }: SearchHeaderProps) {
  ...
  return (
    <div className="relative overflow-hidden border-b py-12">
      ...
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_right,var(--primary-rgb)_0%,transparent_25%)] opacity-10" />
      ...
      <Container>
        <div className="flex flex-col gap-4">
            ...
            {query ? (
              <>
                <span className="opacity-50">
                  {t('searchResultsFor', { defaultValue: 'Results for' })}
                </span>{' '}
          ...
          <motion.div
            ...
            className="bg-primary/20 h-1 w-20 rounded-full"
          />
        </div>
      </Container>
    </div>
