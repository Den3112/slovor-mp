    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {items.map((item, idx) => (
        ...
        >
          ...
          <div className="bg-primary/5 absolute -top-4 -right-4 h-24 w-24 rounded-full opacity-50 blur-2xl" />
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="bg-primary/5 text-primary flex items-center gap-1 rounded-full px-2 py-1 text-[10px] font-bold">
