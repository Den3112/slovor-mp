...
import { useTranslation } from '@/shared/lib/i18n' // Using project's i18n wrapper
import { DashboardShell } from '@/features/dashboard/layouts/dashboard-shell'
import type { SidebarConfig } from '@/features/dashboard/shared/sidebar'
import type { DashboardStats } from '@/entities/dashboard/api/types'
import {
  LayoutDashboard,
  Package,
  ShoppingBag,
