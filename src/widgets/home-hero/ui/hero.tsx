...
export function Hero() {
  ...
  const { filters, updateFilter, listings, isFetching } = useListingSearch()
                          ...
                          {results.map((item: any) => (
                            ...
                            >
                              ...
                              <div className="flex-1 overflow-hidden">
                                <h4 className="text-foreground group-hover:text-primary line-clamp-1 font-bold transition-colors">
                                  {item.title}
                                </h4>
                              ...
                              <ArrowRight className="text-primary hidden h-4 w-4 -translate-x-2 opacity-0 transition-all group-hover:block group-hover:translate-x-0 group-hover:opacity-100" />
                            </button>
                          ))}
                        </div>
                      ) : (
