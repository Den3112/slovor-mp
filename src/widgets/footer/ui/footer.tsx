...
import type {
  ...
  BlogPost,
  StaticPage,
} from '@/shared/lib/types/database'
import {
  getUniqueCategories,
...
import { CURRENCIES } from '@/shared/lib/types/currency'
...
export function Footer() {
  ...
  return (
    <footer className="bg-card border-border border-t pt-20 pb-20 antialiased md:pt-28 md:pb-12">
      ...
      <div className="bg-grid-slate-200/50 pointer-events-none absolute inset-0 mask-[linear-gradient(to_bottom,white,transparent)] opacity-10" />
