...
import { FlagSK, FlagUS, FlagCZ, SUPPORTED_LOCALES } from '@/shared/ui/flags'
      ...
      <AnimatePresence>
        {showLangMenu && (
          <motion.div
            ...
            className="shadow-premium border-border bg-card absolute right-0 z-50 mt-3 w-44 overflow-hidden rounded-xl border p-2"
          >
