...
export function PullToRefresh({ children, onRefresh }: PullToRefreshProps) {
  ...
  return (
    ...
    >
      {/* Pull Indicator Area */}
      <motion.div
        className="pointer-events-none absolute right-0 left-0 z-50 flex items-center justify-center overflow-hidden"
        style={{
          height: pullDistance,
          top: 0,
      ...
      >
        <div className="flex flex-col items-center justify-center gap-1">
          <motion.div
            ...
            className="bg-primary shadow-primary/20 rounded-full p-2 text-white shadow-lg"
          >
            <RefreshCcw className="h-4 w-4" />
          </motion.div>
          <span className="text-primary/60 text-[9px] font-bold tracking-widest uppercase">
