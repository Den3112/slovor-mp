...
import { BlogPostForm, BlogPostsTable, BlogManagerHeader } from './blog/index'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const postData = {
        ...
        published_at:
          editingPost.is_published && !editingPost.published_at
      ...
      toast.success(
        editingPost.id ? t('admin:postUpdated') : t('admin:postCreated')
      )
      setEditingPost(null)
      loadPosts()
    } catch (error: any) {
