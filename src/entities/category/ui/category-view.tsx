...
import { ListingGrid } from '@/entities/listing/ui/grid'
    ...
    <div className="container mx-auto min-h-screen overflow-x-hidden px-4 pt-24 pb-12 md:pt-32">
      ...
      <div className="fade-in-up mt-8 mb-16">
        <div className="flex flex-col gap-8 md:flex-row md:items-center">
          <div className="border-border/60 bg-card flex h-24 w-24 items-center justify-center rounded-xl border shadow-sm md:h-32 md:w-32">
            <CategoryIcon
              slug={category.slug}
