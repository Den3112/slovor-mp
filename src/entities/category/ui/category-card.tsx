  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="bg-primary/10 group-hover/card:blur-0 absolute top-6 right-6 flex h-10 w-10 items-center justify-center rounded-full opacity-0 blur-sm transition-all duration-500 group-hover/card:opacity-100">
