...
test.describe('Profile Navigation', () => {
  ...
  test('Navigate through main profile sections', async ({ page }) => {
    ...
    await page
      ...
      .getByRole('link', { name: /Moje inzeráty|My Listings/i })
      .click()
    ...
    await page
      .getByTestId('dashboard-sidebar')
      .getByRole('link', { name: /Obľúbené|Favorites/i })
      .click()
    ...
    await page
      .getByTestId('dashboard-sidebar')
      .getByRole('link', { name: /Správy|Messages/i })
      .click()
    ...
    await page
      .getByTestId('dashboard-sidebar')
      .getByRole('link', { name: /Nastavenia|Settings/i })
      .click()
  ...
  test('Mobile Navigation Drawer', async ({ page }) => {
    ...
    const sidebarInDrawer = page.locator(
      '[role="dialog"] [data-testid="dashboard-sidebar"]'
    )
    await expect(sidebarInDrawer).toBeVisible()

    // Navigate
    await sidebarInDrawer
      .getByRole('link', { name: /Moje inzeráty|My Listings/i })
      .click()
