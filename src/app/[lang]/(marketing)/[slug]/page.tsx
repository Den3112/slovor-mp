    ...
    <main className="relative min-h-screen overflow-hidden pb-24">
      ...
      <Container className="pt-32 md:pt-40">
        <div className="mx-auto max-w-4xl">
          <div className="animate-in fade-in slide-in-from-top-4 mb-8 flex items-center gap-4 duration-700">
          ...
          <div className="shadow-premium border-border/50 bg-card animate-in fade-in slide-in-from-bottom-4 max-w-none rounded-xl border p-8 delay-150 duration-700 md:p-12">
            {/*
                            Content rendering:
                            Since we use premium design, we ensure the content is styled.
                            In a real app, we'd use react-markdown here.
                            Now with HTML sanitization for safety.
                        */}
            <div
              className="prose prose-zinc dark:prose-invert prose-headings:font-bold prose-headings: prose-headings:tracking-tight prose-p:text-lg prose-p:leading-relaxed prose-p:text-zinc-600 dark:prose-p:text-zinc-400 prose-strong:text-foreground prose-strong:font-bold prose-a:text-primary hover:prose-a:underline max-w-none"
