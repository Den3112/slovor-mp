  ...
  return (
    <div className="space-y-6">
      ...
      <div className="from-background/80 via-background/60 to-background/40 group relative flex flex-col gap-4 overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br p-6 shadow-2xl backdrop-blur-xl md:flex-row md:items-center md:justify-between md:p-10">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-pink-500/10 via-transparent to-transparent opacity-50 transition-opacity duration-500 group-hover:opacity-100" />
      ...
      {favoriteListings.length > 0 ? (
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-inner backdrop-blur-md md:p-12">
          <EmptyState
            icon={Heart}
