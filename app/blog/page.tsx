...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      "Discover the most in-demand items this spring. From vintage fashion to sustainable tech, here's what buyers are looking for.",
  ...
  },
  {
    ...
    excerpt:
      "You don't need expensive equipment to take great photos. Learn simple techniques to make your items stand out.",
  ...
  },
  {
    ...
    excerpt:
      "Price too high and nobody buys. Price too low and you lose money. Here's how to find the perfect price for your items.",
  ...
  },
  {
    ...
    excerpt:
      'Second-hand is no longer just about saving money. Explore how sustainable shopping is reshaping consumer habits.',
      ...
      <div className="min-h-screen pt-32 pb-20">
        <Container>
          <div className="text-center">
            <h1 className="mb-4 text-4xl font-black">Blog Coming Soon</h1>
    ...
    <div className="min-h-screen pt-24 pb-20 md:pt-32">
      <Container>
        ...
        <Link
          ...
          className="group border-border/50 bg-card hover:border-primary/30 mb-12 block overflow-hidden rounded-3xl border transition-all hover:shadow-xl"
        >
          <div className="grid gap-0 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-8 md:p-12">
              <span
                className={`mb-4 inline-flex w-fit items-center rounded-full px-3 py-1 text-xs font-medium ${categoryColors[featuredPost.category]}`}
              >
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {otherPosts.map((post) => (
            <Link
              key={post.id}
              href={`/blog/${post.slug}`}
              className="group border-border/50 bg-card hover:border-primary/30 overflow-hidden rounded-2xl border transition-all hover:shadow-lg"
            >
              ...
              <div className="p-6">
                <span
                  className={`mb-3 inline-flex items-center rounded-full px-3 py-1 text-xs font-medium ${categoryColors[post.category]}`}
                >
                  {post.category}
                </span>
        ...
        <div className="from-primary/10 via-primary/5 mt-16 rounded-3xl bg-linear-to-br to-transparent p-8 text-center md:p-12">
          ...
          <div className="mx-auto flex max-w-md flex-col gap-3 sm:flex-row">
            <input
              ...
              className="border-border bg-background focus:border-primary flex-1 rounded-xl border px-4 py-3 focus:outline-none"
            />
            <button className="bg-primary text-primary-foreground hover:bg-primary/90 inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 font-bold transition-colors">
              Subscribe
