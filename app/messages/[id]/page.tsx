...
export default function MessageThreadPage() {
    ...
    const loadMessages = async () => {
        ...
        const { data: convList } = await messagesApi.getConversationsForUser(user.id)
    ...
    const handleSend = async () => {
        ...
        setIsSending(true)
        const { data, error } = await messagesApi.sendMessage(conversationId, user.id, newMessage)
    ...
    return (
        <div className="flex min-h-screen flex-col pt-20">
            {/* Header */}
            <div className="sticky top-20 z-10 border-b border-border/50 bg-background/95 backdrop-blur">
                <Container className="flex items-center gap-4 py-4">
                    ...
                    {otherUser && (
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="font-bold">{otherUser.display_name || 'User'}</h1>
            ...
            {/* Input */}
            <div className="sticky bottom-0 border-t border-border/50 bg-background">
                <Container className="py-4">
                    <div className="flex gap-3">
                        <input
                            ...
                            className="flex-1 rounded-2xl border border-border bg-muted/30 px-4 py-3 text-sm focus:border-primary focus:outline-none"
                        />
                        <Button
                            onClick={handleSend}
