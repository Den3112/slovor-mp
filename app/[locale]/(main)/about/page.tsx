        ...
        <div className="mx-auto max-w-4xl space-y-24">
          <div className="grid grid-cols-1 items-stretch gap-6 md:grid-cols-2">
            <div className="bg-card border-border hover:border-primary/20 rounded-2xl border p-8 shadow-sm transition-colors md:p-12">
              <div className="bg-primary/10 border-primary/20 mb-8 flex h-14 w-14 items-center justify-center rounded-xl border">
            ...
            <div className="bg-card border-border hover:border-primary/20 rounded-2xl border p-8 shadow-sm transition-colors md:p-12">
              <div className="mb-8 flex h-14 w-14 items-center justify-center rounded-xl border border-violet-500/20 bg-violet-500/10">
