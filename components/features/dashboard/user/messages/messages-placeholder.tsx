...
export function MessagesPlaceholder() {
    ...
    return (
        <div className="flex h-full flex-col items-center justify-center p-8 text-center text-muted-foreground animate-in fade-in zoom-in-95 duration-500 bg-background/30">
            ...
            <p className="mx-auto max-w-xs text-xs font-bold uppercase tracking-widest opacity-60">
