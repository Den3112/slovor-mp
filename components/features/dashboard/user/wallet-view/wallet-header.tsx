    ...
    <div className="border-border relative overflow-hidden rounded-lg border bg-slate-950 p-8 text-white shadow-sm md:p-12">
      <div className="relative z-10 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex gap-4">
          <button
            onClick={onAddFunds}
            className="bg-primary hover:bg-primary/90 flex h-12 items-center gap-3 rounded-lg px-6 text-[10px] font-bold tracking-[0.2em] uppercase transition-all active:scale-95"
          >
