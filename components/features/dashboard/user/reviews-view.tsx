        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          <div className="bg-muted/30 border-border/50 flex h-fit w-fit items-center gap-1.5 rounded-lg border p-1">
            <Button
              ...
              variant="ghost"
              className={cn(
                'rounded px-6 py-2 text-xs font-bold tracking-widest uppercase transition-all hover:bg-transparent',
                activeTab === 'received'
                    ...
                    <div className="flex flex-col gap-5 sm:flex-row">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                          ...
                          <div className="bg-muted/40 border-border/50 flex w-fit gap-0.5 rounded-lg border p-1.5">
                            {[1, 2, 3, 4, 5].map((star) => (
                              <Star
                                key={star}
                                className={cn(
