    ...
    <div className="flex min-h-[calc(100vh-var(--header-height))]">
      <Container className="flex flex-1 items-start gap-0 p-0 sm:px-6 lg:px-8">
        ...
        <div className="flex min-h-[calc(100vh-var(--header-height))] min-w-0 flex-1 flex-col">
          ...
          <div className="border-border/60 bg-background/50 backdrop-blur-md mx-4 mt-4 flex h-12 shrink-0 items-center justify-between rounded-xl border px-6 py-2 shadow-sm">
