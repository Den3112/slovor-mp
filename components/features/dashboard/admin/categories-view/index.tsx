            ...
            cell: (row) => (
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        <span className="text-sm font-bold tracking-tight text-foreground">{row.name}</span>
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex items-center gap-2">
                    <Badge variant="outline" className="bg-muted/50 font-bold text-[10px] uppercase tracking-widest border-border/40 px-3 py-1 rounded-lg">
                        {row.listing_count || 0}
                    </Badge>
                </div>
            )
