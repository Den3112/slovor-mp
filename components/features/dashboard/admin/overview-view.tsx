        ...
        >
            ...
            <motion.div variants={item} className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div className="space-y-1">
                    <h1 className="text-3xl font-bold tracking-tight text-foreground uppercase">{t('admin:overview')}</h1>
                ...
                <div className="flex gap-2">
                    <Button variant="outline" size="sm" className="text-[10px] font-bold uppercase tracking-widest border-border/60 h-9 px-4 rounded-xl hover:bg-muted transition-all">
                        <Download className="h-3.5 w-3.5 mr-2" />
                        {t('common:export')}
                    </Button>
                    <Button size="sm" className="text-[10px] font-bold uppercase tracking-widest shadow-sm bg-primary h-9 px-4 rounded-xl hover:bg-primary/90 transition-all active:scale-95">
                        ...
                        <CardHeader className="border-b border-border/40 bg-muted/20 px-6 py-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-[10px] text-muted-foreground/40 mt-1 uppercase tracking-widest font-bold">{t('admin:activityMetricsDesc') || 'Global Traffic & Conversion'}</p>
                                </div>
                                <div className="flex bg-muted/30 p-1 rounded-lg border border-border/40">
                                    <button className="px-3 py-1 text-[9px] font-bold uppercase tracking-widest text-muted-foreground/60 hover:text-foreground transition-colors">{t('admin:days7')}</button>
                                    <button className="px-3 py-1 text-[9px] font-bold uppercase tracking-widest bg-card text-primary rounded-md shadow-sm border border-border/40">{t('admin:days30')}</button>
                                </div>
                            </div>
                        </CardHeader>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[11px] font-bold uppercase tracking-widest text-white/40">Database</span>
                                    </div>
                                    <span className="text-[10px] font-bold text-success uppercase tracking-widest px-2 py-0.5 rounded-sm border border-success/20 bg-success/5">Operational</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <div className="h-8 w-8 rounded-lg bg-white/5 flex items-center justify-center border border-white/5">
                                        ...
                                        <span className="text-[11px] font-bold uppercase tracking-widest text-white/40">API Latency</span>
                                    </div>
                                    <span className="text-[10px] font-bold text-white uppercase tracking-widest">24ms</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <div className="h-8 w-8 rounded-lg bg-white/5 flex items-center justify-center border border-white/5">
                                        ...
                                        <span className="text-[11px] font-bold uppercase tracking-widest text-white/40">SSL Status</span>
                                    </div>
                                    <span className="text-[10px] font-bold text-success uppercase tracking-widest px-2 py-0.5 rounded-sm border border-success/20 bg-success/5">Secure</span>
                                </div>
                            </div>

                            <div className="pt-4 border-t border-white/5 mt-4">
                                <Button size="sm" className="w-full bg-white/5 hover:bg-white/10 text-white rounded-xl h-11 text-[9px] font-bold uppercase tracking-widest border-0 transition-all active:scale-95">
