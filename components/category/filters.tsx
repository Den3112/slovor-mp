...
export function Filters() {
  ...
  return (
    <div className="border-border/60 bg-card relative mb-8 overflow-hidden rounded-xl border p-6 shadow-sm">
        ...
        <div className="col-span-1 space-y-3 md:col-span-2 lg:col-span-1">
          ...
          <div className="flex items-center gap-2">
            <Input
              ...
              className="h-12 w-full rounded-xl px-4 text-sm font-bold"
            />
