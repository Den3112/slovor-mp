        ...
        {getPageNumbers().map((page, index) => {
          ...
          return (
            <Button
              ...
              className={
                isActive
                  ? 'bg-primary text-primary-foreground shadow-primary/25 ring-primary hover:bg-primary/90 h-10 w-10 rounded-lg shadow-lg ring-2 ring-offset-2'
                  : 'border-border/50 bg-card text-muted-foreground hover:bg-muted hover:text-foreground h-10 w-10 rounded-lg'
              }
            >
              {pageNum}
            </Button>
