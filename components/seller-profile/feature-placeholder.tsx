  ...
  return (
    <div className="animate-in fade-in zoom-in flex min-h-[60vh] flex-col items-center justify-center duration-500">
      <div className="relative mb-8">
        <div className="bg-card border-border/60 shadow-sm relative rounded-xl border p-6">
      ...
      <p className="text-muted-foreground mb-10 max-w-lg text-center text-lg font-bold leading-relaxed">
        {description}
      </p>
