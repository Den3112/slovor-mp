...
export function SellerProfileView({
  ...
  return (
    <PremiumBackground variant="mesh" className={variant === 'public' ? 'pb-20' : 'pb-12'}>
      {/* Breadcrumbs / Back button - Only for public */}
      {variant === 'public' && (
        <Container className="py-6 pt-24 md:pt-32 animate-in fade-in slide-in-from-left-4 duration-700">
          <Link
      ...
      <Wrapper {...wrapperProps}>
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div
              className={
              ...
              {variant === 'public' ? (
                ...
                <Link href={`/${locale}/dashboard/settings`} className="block">
                  <Button
                    variant="outline"
                    size="xl"
                    className="border-border hover:bg-accent w-full rounded-xl border font-bold tracking-widest uppercase transition-all hover:border-primary/20"
                  >
                    {t('profile:settings')}
                  </Button>
                </Link>
              ...
              <div className="border-border flex items-center justify-between border-b pb-6">
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 text-sm font-medium">
                    {t('seller:allListingsFrom', { defaultValue: 'All listings from this seller' })}
                  </p>
                </div>
