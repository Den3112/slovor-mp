...
export function CurrencyProvider({ children }: { children: ReactNode }) {
    ...
    const formatPrice = useCallback((amount: number, baseCurrency: string = 'EUR'): string => {
        const converted = convertPrice(amount, baseCurrency as CurrencyCode, currency)
        ...
        return new Intl.NumberFormat(currencyInfo.locale, {
            ...
            maximumFractionDigits: currency === 'EUR' || currency === 'USD' || currency === 'GBP' ? 2 : 0,
        }).format(converted)
