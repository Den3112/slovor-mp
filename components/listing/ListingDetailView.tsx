...
export function ListingDetailView({ listing }: ListingDetailViewProps) {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-muted/30 pb-20">
        ...
        <div className="mt-8 grid grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          <div className="space-y-12 lg:col-span-8">
            ...
            <div className="space-y-6">
              <div className="group overflow-hidden rounded-[3rem] border border-border bg-card shadow-2xl shadow-primary/5">
                ...
                <div className="scrollbar-hide flex gap-4 overflow-x-auto pb-4">
                  {listing.images.map((img, idx) => (
                    <button
                      ...
                      className={`relative h-24 w-24 flex-shrink-0 overflow-hidden rounded-2xl border-4 transition-all ${activeImage === idx ? 'scale-105 border-primary shadow-lg' : 'border-transparent opacity-60 hover:opacity-100'}`}
                    >
                      <Image
                        src={img}
            ...
            {/* Content Details */}
            <div className="rounded-[3rem] border border-border bg-card p-10 shadow-xl shadow-primary/5 md:p-16">
              <div className="mb-10 flex flex-col gap-4">
                <div className="flex items-start justify-between gap-4">
                  <h1 className="text-4xl font-black leading-tight tracking-tighter text-foreground md:text-6xl">
                    {localizedTitle}
                  </h1>
                  <div className="flex gap-2">
                    <button
                      onClick={handleShare}
                      className="flex h-12 w-12 items-center justify-center rounded-2xl border-2 border-border bg-card text-muted-foreground transition-all hover:border-primary/50 hover:text-primary active:scale-95"
                    >
              ...
              <div className="prose prose-blue max-w-none">
                <h3 className="mb-6 flex items-center gap-3 text-2xl font-black text-foreground">
          ...
          <div className="space-y-8 lg:col-span-4">
            {/* Contact Card */}
            <div className="sticky top-32 overflow-hidden rounded-[3rem] border-4 border-primary/10 bg-card p-10 shadow-2xl shadow-primary/10">
              {/* Decorative background circle */}
              <div className="absolute -right-20 -top-20 h-44 w-44 rounded-full bg-primary/5 blur-3xl" />

              <h3 className="relative mb-8 text-2xl font-black text-foreground">
              ...
              <div className="relative space-y-4">
                <Button
                  ...
                  className="flex w-full gap-3 rounded-2xl bg-primary py-8 text-lg font-black text-primary-foreground shadow-lg transition-all hover:bg-primary/90 hover:shadow-primary/20"
                >
                ...
                <Button
                  ...
                  className="flex w-full gap-3 rounded-2xl bg-emerald-500 py-8 text-lg font-black text-white shadow-lg transition-all hover:bg-emerald-600 hover:shadow-emerald-500/20"
                >
                ...
                <Button
                  ...
                  disabled={isContactLoading}
                  variant="outline"
                  className="flex w-full gap-3 rounded-2xl border-2 border-border py-8 text-lg font-black text-muted-foreground transition-all hover:text-foreground"
                >
                  <Mail className="h-6 w-6" /> {t.listing.sendMessage}
                </Button>
              </div>

              <p className="mt-8 text-center text-[10px] font-black uppercase tracking-widest text-muted-foreground/50">
                {t.listing.responseTime}
              </p>
            </div>

            {/* Metadata Card */}
            <div className="space-y-8 rounded-[2.5rem] border border-border bg-card p-10 shadow-xl shadow-primary/5">
