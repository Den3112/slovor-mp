    ...
    <div className={cn('space-y-4', className)}>
      ...
      {onBuy && (
        <Button
          size="lg"
          data-action="buy"
          className="bg-primary text-primary-foreground shadow-primary/20 h-16 w-full rounded-xl text-lg font-bold tracking-widest uppercase shadow-xl transition-all active:scale-[0.98]"
          onClick={onBuy}
        >
      ...
      <Button
        ...
        data-action="contact"
        className={cn(
          'h-16 w-full rounded-xl text-lg font-bold tracking-widest uppercase transition-all active:scale-[0.98]',
          onBuy
      ...
      {!showPhone ? (
        <Button
          ...
          size="lg"
          data-action="call"
          className="hover:border-primary/30 border-border bg-muted/40 hover:bg-muted/60 h-16 w-full gap-3 rounded-xl font-bold tracking-widest uppercase transition-all"
          onClick={onCall}
        >
