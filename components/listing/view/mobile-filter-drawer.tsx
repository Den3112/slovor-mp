...
export function MobileFilterDrawer({ categories, totalCount, isOpen, onOpenChange }: MobileFilterDrawerProps) {
                ...
                <Drawer.Portal>
                    ...
                    <Drawer.Content className="border-border bg-background fixed inset-x-0 bottom-0 z-50 mt-24 flex h-[85vh] flex-col rounded-t-xl border-t outline-none">
                        ...
                        <div className="border-border/40 safe-bottom border-t p-4">
                            ...
                            >
                                {t('common:showResultCount', { count: totalCount }) || `Show ${totalCount} Listings`}
                            </Button>
                        </div>
                    </Drawer.Content>
                </Drawer.Portal>
