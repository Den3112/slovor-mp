        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-4xl">
            <motion.span
              ...
              className="glass mb-10 inline-block rounded-full border-white/10 px-6 py-2 text-[10px] font-black uppercase tracking-[0.3em] text-white"
            >
              Join the Community
            </motion.span>
            <motion.h2
              ...
              className="mb-12 font-heading text-6xl font-black leading-[0.9] tracking-tighter md:text-[5.5rem]"
            >
              {t.home.ctaTitle}
            </motion.h2>
            <motion.p
              ...
              className="mx-auto mb-16 max-w-xl text-xl font-medium leading-relaxed text-white/60 md:text-2xl"
            >
              {t.home.ctaSubtitle}
            </motion.p>
            <motion.div
            ...
            >
              <Button
                asChild
                size="lg"
                className="group h-20 rounded-[2rem] bg-card px-14 text-xl font-black text-foreground shadow-2xl transition-all hover:scale-105 hover:bg-card/90 hover:shadow-[0_20px_40px_rgba(255,255,255,0.2)]"
              >
                <Link href="/post">
