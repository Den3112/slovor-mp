...
import { Edit, Trash2, Eye, Clock, ExternalLink, Power, AlertTriangle } from 'lucide-react'
            ...
            <div className="group relative flex items-center gap-4 rounded-2xl border border-border/40 bg-card p-3 transition-all hover:bg-muted/30 hover:border-primary/20">
                ...
                <div className="flex items-center gap-1">
                    <Link href={`/listings/${listing.id}`}>
                        <Button size="icon" variant="ghost" className="h-9 w-9 text-muted-foreground hover:text-primary" title="View">
