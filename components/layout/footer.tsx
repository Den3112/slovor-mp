...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-border/10 bg-background pb-24 pt-16 text-muted-foreground md:pb-16 md:pt-24 lg:pt-32">
      {/* Decorative Elements - Hidden on mobile */}
      <div className="pointer-events-none absolute right-0 top-0 hidden h-[600px] w-[600px] -translate-y-1/2 translate-x-1/2 rounded-full bg-indigo-500/10 blur-[150px] md:block" />
        ...
        <div className="mb-12 grid grid-cols-1 gap-8 md:mb-24 md:grid-cols-2 md:gap-12 lg:mb-32 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="space-y-6 md:space-y-10 lg:col-span-4">
            <Link href="/" className="group inline-flex items-center gap-3 md:gap-4">
              ...
              <span className="text-2xl font-black tracking-tighter text-foreground md:text-4xl">
                Slovor
