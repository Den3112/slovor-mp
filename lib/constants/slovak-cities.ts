...
export const SLOVAK_REGIONS: SlovakRegion[] = [
    {
        ...
        cities: [
            ...
            { name: 'Ivanka pri Dunaji', nameSk: 'Ivanka pri Dunaji', district: 'Senec' },
        ],
    },
    {
        name: 'Trnava Region',
        ...
        cities: [
            ...
            { name: 'Dunajská Streda', nameSk: 'Dunajská Streda', district: 'Dunajská Streda' },
    ...
    },
    {
        ...
        cities: [
            ...
            { name: 'Považská Bystrica', nameSk: 'Považská Bystrica', district: 'Považská Bystrica' },
            { name: 'Prievidza', nameSk: 'Prievidza', district: 'Prievidza' },
            { name: 'Partizánske', nameSk: 'Partizánske', district: 'Partizánske' },
            { name: 'Dubnica nad Váhom', nameSk: 'Dubnica nad Váhom', district: 'Ilava' },
            { name: 'Nové Mesto nad Váhom', nameSk: 'Nové Mesto nad Váhom', district: 'Nové Mesto nad Váhom' },
            { name: 'Púchov', nameSk: 'Púchov', district: 'Púchov' },
            { name: 'Handlová', nameSk: 'Handlová', district: 'Prievidza' },
            { name: 'Bánovce nad Bebravou', nameSk: 'Bánovce nad Bebravou', district: 'Bánovce nad Bebravou' },
    ...
    },
    {
        ...
        cities: [
            ...
            { name: 'Zlaté Moravce', nameSk: 'Zlaté Moravce', district: 'Zlaté Moravce' },
    ...
    },
    {
        ...
        cities: [
            ...
            { name: 'Liptovský Mikuláš', nameSk: 'Liptovský Mikuláš', district: 'Liptovský Mikuláš' },
            { name: 'Ružomberok', nameSk: 'Ružomberok', district: 'Ružomberok' },
            { name: 'Kysucké Nové Mesto', nameSk: 'Kysucké Nové Mesto', district: 'Kysucké Nové Mesto' },
            { name: 'Bytča', nameSk: 'Bytča', district: 'Bytča' },
            { name: 'Námestovo', nameSk: 'Námestovo', district: 'Námestovo' },
            { name: 'Turčianske Teplice', nameSk: 'Turčianske Teplice', district: 'Turčianske Teplice' },
        ],
    },
    {
        ...
        cities: [
            { name: 'Banská Bystrica', nameSk: 'Banská Bystrica', district: 'Banská Bystrica' },
            { name: 'Zvolen', nameSk: 'Zvolen', district: 'Zvolen' },
            { name: 'Lučenec', nameSk: 'Lučenec', district: 'Lučenec' },
            { name: 'Rimavská Sobota', nameSk: 'Rimavská Sobota', district: 'Rimavská Sobota' },
            { name: 'Brezno', nameSk: 'Brezno', district: 'Brezno' },
            { name: 'Žiar nad Hronom', nameSk: 'Žiar nad Hronom', district: 'Žiar nad Hronom' },
    ...
    },
    {
        ...
        cities: [
            ...
            { name: 'Vranov nad Topľou', nameSk: 'Vranov nad Topľou', district: 'Vranov nad Topľou' },
            { name: 'Snina', nameSk: 'Snina', district: 'Snina' },
            { name: 'Svidník', nameSk: 'Svidník', district: 'Svidník' },
            { name: 'Stará Ľubovňa', nameSk: 'Stará Ľubovňa', district: 'Stará Ľubovňa' },
            ...
            { name: 'Medzilaborce', nameSk: 'Medzilaborce', district: 'Medzilaborce' },
        ],
    },
    {
        name: 'Košice Region',
        ...
        cities: [
            ...
            { name: 'Spišská Nová Ves', nameSk: 'Spišská Nová Ves', district: 'Spišská Nová Ves' },
            { name: 'Trebišov', nameSk: 'Trebišov', district: 'Trebišov' },
            { name: 'Rožňava', nameSk: 'Rožňava', district: 'Rožňava' },
            { name: 'Moldava nad Bodvou', nameSk: 'Moldava nad Bodvou', district: 'Košice-okolie' },
            { name: 'Gelnica', nameSk: 'Gelnica', district: 'Gelnica' },
            { name: 'Sobrance', nameSk: 'Sobrance', district: 'Sobrance' },
            { name: 'Kráľovský Chlmec', nameSk: 'Kráľovský Chlmec', district: 'Trebišov' },
...
export function searchSlovakCities(query: string, limit: number = 10): SlovakCity[] {
    if (!query || query.length < 2) return []

    const normalizedQuery = query.toLowerCase().trim()

    return ALL_SLOVAK_CITIES
        .filter(
            (city) =>
